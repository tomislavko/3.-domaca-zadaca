...
namespace Zadatak1
{
    ...
    {
        /// <summary >
        /// Gets TodoItem for a given id. Throw TodoAccessDeniedException with appropriate 
        ...
        /// If TodoItem does not exist , method will add one . Throw TodoAccessDeniedException with 
        ...
        /// <summary >
        /// Tries to mark a TodoItem as completed in database . Throw TodoAccessDeniedException with 
        /// appropriate message if user is not the owner of the Todo item
        /// </ summary >
        /// <param name =" todoId " > Todo Id </ param >
